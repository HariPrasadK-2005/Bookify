        ...
        public async Task<IActionResult> GetIncomingRequests()
        {
            ...
            var requests = await _context.ExchangeRequests
                ...
                .Select(e => new ExchangeRequestResponseDto
                {
                    ...
                    SenderAverageRating = e.Sender!.AverageRating,
                    SenderRatingCount = e.Sender!.RatingCount,
                    ReceiverId = e.ReceiverId,
                    ReceiverName = "Me",
                    ReceiverEmail = e.Receiver!.Email,
                    ReceiverPhone = e.Receiver!.PhoneNumber,
                    ReceiverAverageRating = e.Receiver!.AverageRating,
                    ReceiverRatingCount = e.Receiver!.RatingCount,
